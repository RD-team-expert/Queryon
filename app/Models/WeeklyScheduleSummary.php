...
class WeeklyScheduleSummary extends Model
{
    ...
    protected $fillable = [
        'store', 'schedule_date', 'name', 'emp_id', 'x', 'oje', 'off_both_we',
        'status_not_filled', 'hours_not_given', 'dh_not_scheduled', 'headcount',
        'weekend_not_filling_status', 'weekly_hours', 'ot_calc', 'both_weekends',
